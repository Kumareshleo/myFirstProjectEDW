...
public class Driver {
	...
	public void Initialize(@Optional("GoogleChrome") String browser,
			@Optional("http://leaftaps.com/opentaps/control/main"/* "https://everydaywell.dex.staginghealtheintent.com/pages/home" */) String url,
		...
		if (operatingSystemType.equalsIgnoreCase("64bit")) {
			...
			chromeFilePath = projectPath + "\\resources\\64bit\\chromedriver2.exe";
