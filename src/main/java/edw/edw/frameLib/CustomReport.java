...
public class CustomReport extends Driver implements IReporter {
	...
	protected void writeReportTitle(String title) {
		...
		writer.print("<center><h2><img src=\"D:\\Kumaresh\\logo.png\" title='RAFT' alt='RAFT' name='graphics1' align='CENTER' border='0' height='100' width='300'></h2></center>");
		//writer.print(
//				"<center><h2><img src=\"https://img.sandboxcernerhealth.com/34a2fa94f83d40f1bad87a3945d037fe/EveryDayWell_RGB-Color.png\" title='EDW' alt='EDW' name='graphics1' align='CENTER' border='0' height='100' width='300'></h2></center>");
